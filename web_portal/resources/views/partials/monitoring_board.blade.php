...
<!-- BARRA DE CONTROL DEL MONITOREO (EN DASHBOARD) -->
<div class="flex flex-col md:flex-row md:items-center justify-between gap-3 p-3.5 rounded-xl glass-panel border border-obsidian-border/80 shadow-md">
    <div class="flex items-center space-x-3">
        <div class="w-8 h-8 rounded-lg bg-gradient-to-tr from-obsidian-cyan/20 to-obsidian-purple/30 border border-obsidian-cyan/40 flex items-center justify-center text-obsidian-cyan glow-cyan shrink-0 p-1">
            <img src="{{ asset('img/logo.png') }}" alt="Logo" class="w-full h-full object-contain filter drop-shadow-[0_0_6px_rgba(34,211,238,0.6)]">
        </div>
        <div>
            <h2 class="text-xs sm:text-sm font-bold tracking-tight text-white font-mono flex items-center gap-2">
                SUPERVISIÓN DE INFRAESTRUCTURA EN TIEMPO REAL
            </h2>
            <p class="text-[10px] font-mono text-obsidian-cyan flex items-center gap-1.5">
                ...
                SEDE VALLE SECO • ESTADO DE SERVICIOS Y ENLACES
            </p>
        </div>
    </div>

    <!-- BUSCADOR CENTRAL -->
    <div class="flex-1 max-w-sm mx-0 md:mx-4">
    ...
    <!-- BOTÓN IA, STATUS BADGE & ÚLTIMO ESCANEO -->
    <div class="flex items-center space-x-3 shrink-0">
        ...
        <div class="hidden sm:flex flex-col text-right font-mono text-[11px] text-obsidian-muted">
