...
class AdminAlertController extends Controller
{
    ...
    public function acknowledge(Request $request, int $id): RedirectResponse
    {
        ...
        AuditLog::create([
            ...
            'details' => "Alerta #{$id} ({$alert->entity_name}) reconocida por " . Auth::user()->name,
    ...
    public function resolve(Request $request, int $id): RedirectResponse
    {
        ...
        AuditLog::create([
            ...
            'details' => "Alerta #{$id} ({$alert->entity_name}) resuelta manualmente por " . Auth::user()->name,
            'ip_address' => $request->ip(),
        ]);
    ...
    public function silence(Request $request, int $id): RedirectResponse
    {
        ...
        AuditLog::create([
            ...
            'details' => "Alerta #{$id} ({$alert->entity_name}) silenciada por {$minutes} minutos.",
            'ip_address' => $request->ip(),
        ]);
    ...
    public function storeRule(Request $request): RedirectResponse
    {
        ...
        AuditLog::create([
            ...
            'details' => "Regla de alerta '{$rule->name}' creada por " . Auth::user()->name,
            'ip_address' => $request->ip(),
        ]);
    ...
    public function destroyRule(int $id): RedirectResponse
    {
        ...
        AuditLog::create([
            ...
            'details' => "Regla de alerta '{$name}' eliminada por " . Auth::user()->name,
            'ip_address' => request()->ip(),
        ]);
    ...
    public function storeMaintenance(Request $request): RedirectResponse
    {
        ...
        AuditLog::create([
            ...
            'details' => "Ventana de mantenimiento '{$window->title}' creada por " . Auth::user()->name,
            'ip_address' => $request->ip(),
        ]);
    ...
    public function destroyMaintenance(int $id): RedirectResponse
    {
        ...
        AuditLog::create([
            ...
            'details' => "Ventana de mantenimiento '{$title}' eliminada por " . Auth::user()->name,
            'ip_address' => request()->ip(),
        ]);
    ...
    public function storeCorrelation(Request $request): RedirectResponse
    {
        ...
        AuditLog::create([
            'user_id' => Auth::id(),
            'action' => 'correlation_group_created',
            'details' => "Grupo de correlación '{$group->name}' creado por " . Auth::user()->name,
            'ip_address' => $request->ip(),
        ]);
    ...
    public function destroyCorrelation(int $id): RedirectResponse
    {
        ...
        AuditLog::create([
            'user_id' => Auth::id(),
            'action' => 'correlation_group_deleted',
            'details' => "Grupo de correlación '{$name}' eliminado por " . Auth::user()->name,
            'ip_address' => request()->ip(),
        ]);
