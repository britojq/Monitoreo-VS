    ...
    public function run(): void
    {
        ...
        MonitoredService::updateOrCreate(
            ...
            [
                ...
                'type' => 'WEB',
                'host_ip' => '10.18.32.6',
                'web_url' => 'http://gsatit.empresa.local/otrs/index.pl',
                'port' => 25,
        ...
        MonitoredService::updateOrCreate(
            ['letter' => 'B'],
            [
                'name' => 'INTRANET CORPORATIVO',
                'type' => 'WEB',
                'host_ip' => '10.16.2.28',
                'web_url' => 'http://intranet.empresa.local',
                'port' => 25,
                'credentials' => 'USUARIO:CLAVE',
                'check_interface' => 'eno1',
                'dns_test_domain' => 'intranet.empresa.local',
        ...
        MonitoredService::updateOrCreate(
            ...
            [
                ...
                'web_url' => 'http://correo.empresa.local//login.php?phpgw_forward=%2Findex.php',
                'port' => 25,
                'credentials' => 'USUARIO:CLAVE',
                'check_interface' => 'eno1',
                'dns_test_domain' => 'intranet.empresa.local',
        ...
        MonitoredService::updateOrCreate(
            ...
            [
                ...
                'type' => 'WEB',
                'host_ip' => '10.96.0.136',
                'web_url' => 'https://saocorp.empresa.local:3002/login?service=https%3A%2F%2Fsaocorp.empresa.local%3A6200%2F',
                'port' => 25,
                'credentials' => 'USUARIO:CLAVE',
                'check_interface' => 'eno1',
                'dns_test_domain' => 'intranet.empresa.local',
        ...
        MonitoredService::updateOrCreate(
            ...
            [
                ...
                'type' => 'WEB',
                'host_ip' => '10.16.2.62',
                'web_url' => 'http://surge.empresa.local/gestion-incidencias-cliente-web/ui/FrmTablero.html',
                'port' => 25,
                'credentials' => 'USUARIO:CLAVE',
                'check_interface' => 'eno1',
                'dns_test_domain' => 'intranet.empresa.local',
        ...
        MonitoredService::updateOrCreate(
            ...
            [
                ...
                'type' => 'WEB',
                'host_ip' => '10.16.2.28',
                'web_url' => 'http://facturadigital.empresa.local/',
                'port' => 25,
                'credentials' => 'USUARIO:CLAVE',
                'check_interface' => 'eno1',
                'dns_test_domain' => 'intranet.empresa.local',
        ...
        MonitoredService::updateOrCreate(
            ...
            [
                ...
                'type' => 'WEB',
                'host_ip' => '10.16.2.22',
                'web_url' => 'http://cambioclaves.empresa.local/gc/',
                'port' => 25,
                'credentials' => 'USUARIO:CLAVE',
                'check_interface' => 'eno1',
                'dns_test_domain' => 'intranet.empresa.local',
        ...
        MonitoredService::updateOrCreate(
            ...
            [
                ...
                'type' => 'WEB',
                'host_ip' => '10.16.2.22',
                'web_url' => 'https://claver1-sb.empresa.local/',
                'port' => 25,
                'credentials' => 'USUARIO:CLAVE',
                'check_interface' => 'eno1',
                'dns_test_domain' => 'intranet.empresa.local',
        ...
        MonitoredService::updateOrCreate(
            ...
            [
                ...
                'type' => 'WEB',
                'host_ip' => '10.2.28.64',
                'web_url' => 'https://ldapadmin.empresa.local/htdocs/index.php',
                'port' => 25,
                'credentials' => 'USUARIO:CLAVE',
                'check_interface' => 'eno1',
                'dns_test_domain' => 'intranet.empresa.local',
        ...
        MonitoredService::updateOrCreate(
            ['letter' => 'K'],
            [
                'name' => 'SAP - CORPORATIVO Produccion R3',
                'type' => 'OTRO',
        ...
        MonitoredService::updateOrCreate(
            ...
            [
                ...
                'type' => 'LDAP',
                'host_ip' => '10.16.2.24',
                'web_url' => 'ldapr2-t4.empresa.local',
                'port' => 25,
                'credentials' => 'USUARIO:CLAVE',
                'check_interface' => 'eno1',
                'dns_test_domain' => 'intranet.empresa.local',
        ...
        MonitoredService::updateOrCreate(
            ...
            [
                ...
                'type' => 'DHCP',
                'host_ip' => '10.18.32.38',
                'web_url' => 't4linp38.empresa.local',
                'port' => 25,
                'credentials' => 'USUARIO:CLAVE',
                'check_interface' => 'eno1',
                'dns_test_domain' => 'intranet.empresa.local',
        ...
        MonitoredService::updateOrCreate(
            ...
            [
                ...
                'type' => 'SMTP',
                'host_ip' => '10.18.32.6',
                'web_url' => 'mailr2-t4.empresa.local',
                'port' => 25,
                'credentials' => 'USUARIO:CLAVE',
                'check_interface' => 'eno1',
                'dns_test_domain' => 'intranet.empresa.local',
        ...
        $siteE = MonitoredSite::updateOrCreate(
            ...
            [
                ...
                'phone_7' => 'NO CONFIGURADO',
                'phone_8' => 'NO CONFIGURADO',
                'address' => 'Edificio CORPORATIVO, Calle San José con calle Miranda Diagonal a casa de la Cultura, Moron - Edo Carabobo',
